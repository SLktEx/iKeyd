...
/// the runtime has no LT/MT/MO-specific dispatch path.
/// </summary>
public static class StandardBehaviors
{
    ...
    /// <summary>
    /// Emits one primitive action on physical key-down and consumes the matching
    /// key-up. PC helpers lower to this definition rather than adding helper-name
    /// execution branches to platform routers.
    /// </summary>
